  ...
  return (
    <div className="min-h-screen bg-black pb-4 ">
      ...
      <main className="flex justify-center items-center">
        <div className="bg-gray-200 w-8/12 flex flex-col items-center justify-center rounded-3xl animate-fadeIn">
          ...
          <section className="flex justify-center text-center p-2">
            <div>
              ...
              <p>
                ...
                Codecademy's Front End Development (add link), and have created
                a number of personal projects. <br /> <br /> In my spare time I enjoy rock
                climbing and DIY, you can usually find me out in the Peak
                District at least once a week with my dog and self-converted
                campervan.
              </p>
            </div>
          </section>
