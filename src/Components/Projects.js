...
const Projects = () => {
  return (
    <div className="min-h-screen bg-black ">
      ...
      <main className="flex-wrap flex gap-y-8 justify-center items-center animate-fadeIn">
        <div className="flex justify-center items-center m-5 ">
          ...
          <div className="bg-gray-300 flex justify-between items-center flex-col w-80 md:w-96 h-64 rounded-3xl p-8 cursor-default z-10  transition duration-500 ease-in opacity-0 hover:opacity-100">
